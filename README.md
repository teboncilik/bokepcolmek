...
A live demo of the project is available at [https://bokepcolmek.pages.dev](https://bokepcolmek.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep colmek`)
...
```bash
git clone <repo-url> bokepcolmek
cd bokepcolmek
```
...
1. Fork the [repository](https://github.com/teboncilik/bokepcolmek/fork) on GitHub.
